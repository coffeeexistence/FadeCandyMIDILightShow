...
public class OPC
{
  ...
  // (x,y) is the center of the grid.
  void ledGrid8x8(int index, float x, float y, float ledSpacing, float stripSpacing, float angle, boolean zigzag)
  {
    ledGrid(index, 8, 8, x, y, ledSpacing, stripSpacing, angle, zigzag);
  }
